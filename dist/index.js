...
var useAllDefaultValues = false;
var customTheme = {};
var hasNegative = (val) => [val[0] === "-" ? "-" : "", val[0] === "-" ? val.slice(1) : val];
var getCustomVal = (val) => {
...
var isColor = (str, joinLinearGradient = false) => {
  const namedColors = [
    "initial",
    "inherit",
    "currentColor",
...
var getUnitMetacharactersVal = (val, excludes = []) => {
  if (/^\d+\.[1-9]{2,}%$/.test(val)) {
...
var getBorderRadiusDefaultVal = (val) => {
  return {
    "0px": "-none",
    "0.125rem": "-sm",
    "0.25rem": "null",
...
var propertyMap = /* @__PURE__ */ new Map([
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "none": "animate-none" }[val]) != null ? _a : `animate-[${getCustomVal(val)}]`;
    }
  ],
  [
    "animation-delay",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "none": "appearance-none" }[val]) != null ? _a : `[appearance:${getCustomVal(val)}]`;
    }
  ],
  [
    "aspect-ratio",
  ...
  [
    ...
    (val) => {
      ...
      const backdropFilterValConfig = {
        blur: (v) => {
          var _a, _b;
          return `backdrop-blur-${(_b = (_a = customTheme["backdrop-blur"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        brightness: (v) => {
          var _a, _b;
          return `backdrop-brightness-${(_b = (_a = customTheme["backdrop-brightness"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        contrast: (v) => {
          var _a, _b;
          return `backdrop-contrast-${(_b = (_a = customTheme["backdrop-contrast"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        grayscale: (v) => {
          var _a, _b;
          return `backdrop-grayscale-${(_b = (_a = customTheme["backdrop-grayscale"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        "hue-rotate": (v) => {
          var _a, _b;
          const t = hasNegative(v);
          return `${t[0]}backdrop-hue-rotate-${(_b = (_a = customTheme["backdrop-grayscale"]) == null ? void 0 : _a[t[1]]) != null ? _b : `[${t[1]}]`}`;
        },
        invert: (v) => {
          var _a, _b;
          return `backdrop-invert-${(_b = (_a = customTheme["backdrop-invert"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        opacity: (v) => {
          var _a, _b;
          return `backdrop-opacity-${(_b = (_a = customTheme["backdrop-opacity"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        saturate: (v) => {
          var _a, _b;
          return `backdrop-saturate-${(_b = (_a = customTheme["backdrop-saturate"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        sepia: (v) => {
          var _a, _b;
          return `backdrop-sepia-${(_b = (_a = customTheme["backdrop-sepia"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        }
      };
      ...
      const res = vals.map((v) => {
        ...
        pipeV = pipeV.length > 0 ? pipeV : v.replace(/^([a-zA-Z0-9_-]+)\((.+?)\)$/, (_r, k, v2) => {
          var _a2, _b;
          canUsePipeV = true;
          return (_b = (_a2 = backdropFilterValConfig[k]) == null ? void 0 : _a2.call(backdropFilterValConfig, v2)) != null ? _b : canUse = false;
        });
  ...
  [
    ...
    (val) => {
      var _a;
      const legalConfig = __spreadProps(__spreadValues(__spreadValues({}, propertyMap.get("background-attachment")), propertyMap.get("background-repeat")), {
      ...
      return (_a = legalConfig[val]) != null ? _a : `bg-[${getCustomVal(val)}]`;
    }
  ],
  [
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "transparent": "bg-transparent", "currentColor": "bg-current", "currentcolor": "bg-current" }[val]) != null ? _a : isColor(val, true) ? `bg-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "background-image",
    (val) => {
      var _a;
      return (_a = { "none": "bg-none" }[val]) != null ? _a : `bg-[${getCustomVal(val)}]`;
    }
  ],
  [
    "background-origin",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "right top": "bg-right-top",
        "top": "bg-top"
      }[val]) != null ? _a : `bg-[${getCustomVal(val)}]`;
    }
  ],
  [
    "background-repeat",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "cover": "bg-cover",
        "contain": "bg-contain"
      }[val]) != null ? _a : `[background-size:${getCustomVal(val)}]`;
    }
  ],
  [
    "border",
    (val) => {
      ...
      const vals = val.split(" ").filter((v) => v !== "").map((v) => {
        var _a, _b;
        return isUnit(v) || isColor(v) ? (_a = { "transparent": "border-transparent", "currentColor": "border-current", "currentcolor": "border-current" }[val]) != null ? _a : `border-[${v}]` : (_b = propertyMap.get("border-style")[v]) != null ? _b : "";
      }).filter((v) => v !== "").join(" ");
      return vals;
    }
  ],
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "rounded-bl-none", "0px": "rounded-bl-none" }[val]) != null ? _a : isUnit(val) ? `rounded-bl${(useAllDefaultValues && getBorderRadiusDefaultVal(val) || `-[${getCustomVal(val)}]`).replace(/null$/, "")}` : "";
    }
  ],
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "rounded-br-none", "0px": "rounded-br-none" }[val]) != null ? _a : isUnit(val) ? `rounded-br${(useAllDefaultValues && getBorderRadiusDefaultVal(val) || `-[${getCustomVal(val)}]`).replace(/null$/, "")}` : "";
    }
  ],
  [
    "border-bottom-style",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "currentcolor": "border-current"
      }[val]) != null ? _a : isColor(val) ? `border-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "border-image",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "rounded-tl-none", "0px": "rounded-tl-none" }[val]) != null ? _a : isUnit(val) ? `rounded-tl${(useAllDefaultValues && getBorderRadiusDefaultVal(val) || `-[${getCustomVal(val)}]`).replace(/null$/, "")}` : "";
    }
  ],
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "rounded-tr-none", "0px": "rounded-tr-none" }[val]) != null ? _a : isUnit(val) ? `rounded-tr${(useAllDefaultValues && getBorderRadiusDefaultVal(val) || `-[${getCustomVal(val)}]`).replace(/null$/, "")}` : "";
    }
  ],
  [
    "border-top-style",
  ...
  [
    ...
    (val) => {
      ...
      return isUnit(val) ? `${t[0]}bottom-${getUnitMetacharactersVal(t[1], ["100vw" /* vw */, "100vh" /* vh */]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "box-align",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "transparent": "text-transparent", "currentColor": "text-current", "currentcolor": "text-current" }[val]) != null ? _a : isColor(val, true) ? `text-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "color-scheme",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "gap-x-0" }[val]) != null ? _a : isUnit(val) ? `gap-x-[${val}]` : "";
    }
  ],
  [
    "column-rule",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "currentColor": "fill-current", "currentcolor": "fill-current" }[val]) != null ? _a : isColor(val, true) ? `fill-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "filter",
    (val) => {
      ...
      const filterValConfig = {
        blur: (v) => {
          var _a, _b;
          return `blur-${(_b = (_a = customTheme["blur"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        brightness: (v) => {
          var _a, _b;
          return `brightness-${(_b = (_a = customTheme["brightness"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        contrast: (v) => {
          var _a, _b;
          return `contrast-${(_b = (_a = customTheme["contrast"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        grayscale: (v) => {
          var _a, _b;
          return `grayscale-${(_b = (_a = customTheme["grayscale"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        "hue-rotate": (v) => {
          var _a, _b;
          const t = hasNegative(v);
          return `${t[0]}hue-rotate-${(_b = (_a = customTheme["grayscale"]) == null ? void 0 : _a[t[1]]) != null ? _b : `[${t[1]}]`}`;
        },
        invert: (v) => {
          var _a, _b;
          return `invert-${(_b = (_a = customTheme["invert"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        saturate: (v) => {
          var _a, _b;
          return `saturate-${(_b = (_a = customTheme["saturate"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        },
        sepia: (v) => {
          var _a, _b;
          return `sepia-${(_b = (_a = customTheme["sepia"]) == null ? void 0 : _a[v]) != null ? _b : `[${v}]`}`;
        }
      };
      const vals = getCustomVal(val).replace(/\(.+?\)/g, (v) => v.replace(/_/g, "")).split(")_").map((v) => `${v})`);
      vals[vals.length - 1] = vals[vals.length - 1].slice(0, -1);
      ...
      const res = vals.map((v) => {
        ...
        let pipeV = "";
        if (useAllDefaultValues) {
          pipeV = (_a = getFilterDefaultVal(v)) != null ? _a : "";
          if (pipeV.length > 0) {
            canUsePipeV = true;
          }
        }
        pipeV = pipeV.length > 0 ? pipeV : v.replace(/^([a-zA-Z0-9_-]+)\((.+?)\)$/, (_r, k, v2) => {
          var _a2, _b;
          canUsePipeV = true;
          return (_b = (_a2 = filterValConfig[k]) == null ? void 0 : _a2.call(filterValConfig, v2)) != null ? _b : canUse = false;
        });
        return canUsePipeV ? pipeV : "";
      });
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "1 1 0%": "flex-1", "1 1 auto": "flex-auto", "0 1 auto": "flex-initial", "none": "flex-none" }[val]) != null ? _a : `flex-[${getCustomVal(val)}]`;
    }
  ],
  [
    "flex-basis",
  ...
  [
    ...
    (val) => {
      var _a;
      return isUnit(val) ? (_a = { "0": "flex-grow-0", "1": "flex-grow" }[val]) != null ? _a : `flex-grow-[${val}]` : "";
    }
  ],
  [
    "flex-shrink",
    (val) => {
      var _a;
      return isUnit(val) ? (_a = { "0": "flex-shrink-0", "1": "flex-shrink" }[val]) != null ? _a : `flex-shrink-[${val}]` : "";
    }
  ],
  [
    "flex-wrap",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "gap-0" }[val]) != null ? _a : isUnit(val) ? `gap-[${val}]` : "";
    }
  ],
  [
    "grid",
  ...
  [
    ...
    (val) => {
      ...
      }[val]) != null ? _a : `auto-cols-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-auto-flow",
  ...
  [
    ...
    (val) => {
      ...
      }[val]) != null ? _a : `auto-rows-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-column",
    (val) => {
      ...
      return (_a = {
        ...
        "1 / -1": "col-span-full"
      }[val]) != null ? _a : `col-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-column-end",
    (val) => {
      ...
      return (_a = {
        ...
        "13": "col-end-13",
        auto: "col-end-auto"
      }[val]) != null ? _a : `col-end-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-column-gap",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "13": "col-start-13",
        "auto": "col-start-auto"
      }[val]) != null ? _a : `col-start-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-gap",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "1 / -1": "row-span-full"
      }[val]) != null ? _a : `row-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-row-end",
    (val) => {
      ...
      return (_a = {
        ...
        "7": "row-end-7",
        auto: "row-end-auto"
      }[val]) != null ? _a : `row-end-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-row-gap",
    (val) => {
      var _a;
      return (_a = { "0": "gap-y-0" }[val]) != null ? _a : isUnit(val) ? `gap-y-[${val}]` : "";
    }
  ],
  [
    "grid-row-start",
    (val) => {
      ...
      return (_a = {
        ...
        "7": "row-start-7",
        "auto": "row-start-auto"
      }[val]) != null ? _a : `row-start-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-rows",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "none": "grid-cols-none"
      }[getCustomVal(val).replace(/_/g, "")]) != null ? _a : `grid-cols-[${getCustomVal(val)}]`;
    }
  ],
  [
    "grid-template-rows",
    (val) => {
      ...
      return (_a = {
        ...
        "none": "grid-rows-none"
      }[getCustomVal(val).replace(/_/g, "")]) != null ? _a : `grid-rows-[${getCustomVal(val)}]`;
    }
  ],
  [
    "hanging-punctuation",
  ...
  [
    "height",
    (val) => isUnit(val) ? `h-${getUnitMetacharactersVal(val, ["100vw" /* vw */]) || `[${val}]`}` : ""
  ],
  [
    "icon",
  ...
  [
    ...
    (val) => {
      const t = hasNegative(val);
      return isUnit(val) ? `${t[0]}left-${getUnitMetacharactersVal(t[1], ["100vw" /* vw */, "100vh" /* vh */]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "letter-spacing",
    (val) => {
      var _a;
      return (_a = { "-0.05em": "tracking-tighter", "-0.025em": "tracking-tight", "0em": "tracking-normal", "0.025em": "tracking-wide", "0.05em": "tracking-wider", "0.1em": "tracking-widest" }[val]) != null ? _a : isUnit(val) ? `tracking-[${val}]` : "";
    }
  ],
  [
    "line-height",
    (val) => {
      var _a;
      return (_a = { "1": "leading-none", "2": "leading-loose", "1.25": "leading-tight", "1.375": "leading-snug", "1.5": "leading-normal", "1.625": "leading-relaxed" }[val]) != null ? _a : isUnit(val) ? `leading-[${val}]` : "";
    }
  ],
  [
    "list-style",
  ...
  [
    ...
    (val) => {
      ...
      }[val]) != null ? _a : `[list-style-position:${getCustomVal(val)}]`;
    }
  ],
  [
    "list-style-type",
    (val) => {
      ...
      }[val]) != null ? _a : `list-[${getCustomVal(val)}]`;
    }
  ],
  [
    "logical-height",
  ...
  [
    "margin",
    (val) => {
      const getPipeVal = (val2) => {
        const r = { "0": "m_0", "0px": "m_0", "auto": "m_auto" }[val2];
        if (r) {
          return r;
        }
        let vals = val2.split(" ").filter((v2) => v2 !== "");
        if (vals.filter((v2) => !isUnit(v2)).length > 0) {
          return "";
        }
        if (useAllDefaultValues) {
          vals = vals.map((v2) => {
            var _a;
            return (_a = getRemDefaultVal(v2)) != null ? _a : `[${v2}]`;
          });
        } else {
          vals = vals.map((v2) => `[${v2}]`);
        }
  ...
  [
    ...
    (val) => {
      var _a;
      const t = hasNegative(val);
      return (_a = { "0": "mb-0", "0px": "mb-0", "auto": "mb-auto" }[val]) != null ? _a : isUnit(val) ? `${t[0]}mb-${useAllDefaultValues && getRemDefaultVal(t[1]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "margin-left",
    (val) => {
      var _a;
      const t = hasNegative(val);
      return (_a = { "0": "ml-0", "0px": "ml-0", "auto": "ml-auto" }[val]) != null ? _a : isUnit(val) ? `${t[0]}ml-${useAllDefaultValues && getRemDefaultVal(t[1]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "margin-right",
    (val) => {
      var _a;
      const t = hasNegative(val);
      return (_a = { "0": "mr-0", "0px": "mr-0", "auto": "mr-auto" }[val]) != null ? _a : isUnit(val) ? `${t[0]}mr-${useAllDefaultValues && getRemDefaultVal(t[1]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "margin-top",
    (val) => {
      var _a;
      const t = hasNegative(val);
      return (_a = { "0": "mt-0", "0px": "mt-0", "auto": "mt-auto" }[val]) != null ? _a : isUnit(val) ? `${t[0]}mt-${useAllDefaultValues && getRemDefaultVal(t[1]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "mask",
  ...
  [
    ...
    (val) => {
      var _a;
      return isUnit(val) ? (_a = { "0px": "max-h-0", "100%": "max-h-full", "100vh": "max-h-screen" }[val]) != null ? _a : `[${val}]` : "";
    }
  ],
  [
    "max-width",
    (val) => {
      var _a;
      return isUnit(val) ? (_a = { "none": "max-w-none", "100%": "max-w-full", "min-content": "max-w-min", "max-content": "max-w-max" }[val]) != null ? _a : `[${val}]` : "";
    }
  ],
  [
    "min-height",
    (val) => {
      var _a;
      return isUnit(val) ? (_a = { "0px": "min-h-0", "100%": "min-h-full", "100vh": "min-h-screen" }[val]) != null ? _a : `[${val}]` : "";
    }
  ],
  [
    "min-width",
    (val) => {
      var _a;
      return isUnit(val) ? (_a = { "0px": "min-w-0", "100%": "min-w-full", "min-content": "min-w-min", "max-content": "min-w-max" }[val]) != null ? _a : `[${val}]` : "";
    }
  ],
  [
    "mix-blend-mode",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "opacity-0", "1": "opacity-100", "0.05": "opacity-5", "0.1": "opacity-10", "0.2": "opacity-20", "0.25": "opacity-25", "0.3": "opacity-30", "0.4": "opacity-40", "0.5": "opacity-50", "0.6": "opacity-60", "0.7": "opacity-70", "0.75": "opacity-75", "0.8": "opacity-80", "0.9": "opacity-90", "0.95": "opacity-95" }[val]) != null ? _a : isUnit(val) ? `opacity-[${val}]` : "";
    }
  ],
  [
    "order",
    (val) => {
      var _a;
      return (_a = { "0": "order-none", "1": "order-1", "2": "order-2", "3": "order-3", "4": "order-4", "5": "order-5", "6": "order-6", "7": "order-7", "8": "order-8", "9": "order-9", "10": "order-10", "11": "order-11", "12": "order-12", "9999": "order-last", "-9999": "order-first" }[val]) != null ? _a : isUnit(val) ? `order-[${val}]` : "";
    }
  ],
  [
    "outline",
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "break-word": "break-words" }[val]) != null ? _a : `[overflow-wrap:${getCustomVal(val)}]`;
    }
  ],
  [
    "overflow-x",
  ...
  [
    ...
    (val) => {
      ...
      if (useAllDefaultValues) {
        vals = vals.map((v) => {
          var _a;
          return (_a = getRemDefaultVal(v)) != null ? _a : `[${v}]`;
        });
      } else {
        vals = vals.map((v) => `[${v}]`);
      }
  ...
  [
    ...
    (val) => {
      var _a;
      return (_a = { "0": "pb-0", "0px": "pb-0" }[val]) != null ? _a : isUnit(val) ? `pb-${useAllDefaultValues && getRemDefaultVal(val) || `[${val}]`}` : "";
    }
  ],
  [
    "padding-left",
    (val) => {
      var _a;
      return (_a = { "0": "pl-0", "0px": "pl-0" }[val]) != null ? _a : isUnit(val) ? `pl-${useAllDefaultValues && getRemDefaultVal(val) || `[${val}]`}` : "";
    }
  ],
  [
    "padding-right",
    (val) => {
      var _a;
      return (_a = { "0": "pr-0", "0px": "pr-0" }[val]) != null ? _a : isUnit(val) ? `pr-${useAllDefaultValues && getRemDefaultVal(val) || `[${val}]`}` : "";
    }
  ],
  [
    "padding-top",
    (val) => {
      var _a;
      return (_a = { "0": "pt-0", "0px": "pt-0" }[val]) != null ? _a : isUnit(val) ? `pt-${useAllDefaultValues && getRemDefaultVal(val) || `[${val}]`}` : "";
    }
  ],
  [
    "page-break-after",
  ...
  [
    ...
    (val) => {
      const t = hasNegative(val);
      return isUnit(val) ? `${t[0]}right-${getUnitMetacharactersVal(t[1], ["100vw" /* vw */, "100vh" /* vh */]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "rotation",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        currentcolor: "stroke-current"
      }[val]) != null ? _a : isColor(val, true) ? `stroke-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "stroke-width",
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "clip": "overflow-clip"
      }[val]) != null ? _a : `[text-overflow:${getCustomVal(val)}]`;
    }
  ],
  [
    "text-shadow",
  ...
  [
    ...
    (val) => {
      const t = hasNegative(val);
      return isUnit(val) ? `${t[0]}top-${getUnitMetacharactersVal(t[1], ["100vw" /* vw */, "100vh" /* vh */]) || `[${t[1]}]`}` : "";
    }
  ],
  [
    "transform",
    (val) => {
      ...
      const transformValConfig = {
        scale: (v) => {
          ...
          if (vs[0] === vs[1] || vs.length === 1) {
            return `scale-${((_a = customTheme.scale) == null ? void 0 : _a[vs[0]]) || useAllDefaultValues && scaleDefaultVs[vs[0]] || `[${vs[0]}]`}`;
          }
          return vs.map((v2, idx) => {
            var _a2;
            return `scale-${idx === 0 ? "x" : "y"}-${((_a2 = customTheme.scale) == null ? void 0 : _a2[v2]) || useAllDefaultValues && scaleDefaultVs[v2] || `[${v2}]`}`;
          }).join(" ");
        },
        scaleX: (v) => {
          var _a;
          return `scale-x-${((_a = customTheme.scale) == null ? void 0 : _a[v]) || useAllDefaultValues && scaleDefaultVs[v] || `[${v}]`}`;
        },
        scaleY: (v) => {
          var _a;
          return `scale-y-${((_a = customTheme.scale) == null ? void 0 : _a[v]) || useAllDefaultValues && scaleDefaultVs[v] || `[${v}]`}`;
        },
        rotate: (v) => {
          var _a, _b;
          const vs = v.split(",");
          if (vs.length > 1) {
            if (vs.length === 3 && ["0", "0deg"].findIndex((v2) => v2 === vs[0]) > -1 && ["0", "0deg"].findIndex((v2) => v2 === vs[1]) > -1) {
              const t2 = hasNegative(vs[2]);
              return `${t2[0]}rotate-${((_a = customTheme.rotate) == null ? void 0 : _a[t2[1]]) || useAllDefaultValues && rotateDefaultVs[t2[1]] || `[${t2[1]}]`}`;
            }
            return void 0;
          }
          const t = hasNegative(vs[0]);
          return `${t[0]}rotate-${((_b = customTheme.rotate) == null ? void 0 : _b[t[1]]) || useAllDefaultValues && rotateDefaultVs[t[1]] || `[${t[1]}]`}`;
        },
        rotateZ: (v) => {
          var _a;
          const t = hasNegative(v);
          return `${t[0]}rotate-${((_a = customTheme.rotate) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && rotateDefaultVs[t[1]] || `[${t[1]}]`}`;
        },
        translate: (v) => {
          const vs = v.split(",");
          if (vs.length === 3) {
          ...
          return vs.map((v2, idx) => {
            var _a;
            const t = hasNegative(v2);
            if (/^\d+\.[1-9]{2,}%$/.test(t[1])) {
              t[1] = `${Number(t[1].slice(0, -1)).toFixed(6).replace(/(\.[1-9]{2})\d+/, "$1")}%`;
            }
            return `${t[0]}translate-${idx === 0 ? "x" : "y"}-${((_a = customTheme.translate) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && translateDefaultVs[t[1]] || `[${t[1]}]`}`;
          }).join(" ");
        },
        translateX: (v) => {
          var _a;
          ...
          return `${t[0]}translate-x-${((_a = customTheme.translate) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && translateDefaultVs[t[1]] || `[${t[1]}]`}`;
        },
        translateY: (v) => {
          var _a;
          const t = hasNegative(v);
          ...
          return `${t[0]}translate-y-${((_a = customTheme.translate) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && translateDefaultVs[t[1]] || `[${t[1]}]`}`;
        },
        skew: (v) => {
          const vs = v.split(",");
          if (vs.length === 3) {
          ...
          return vs.map((v2, idx) => {
            var _a;
            const t = hasNegative(v2);
            return `${t[0]}skew-${idx === 0 ? "x" : "y"}-${((_a = customTheme.skew) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && skewDefaultVs[t[1]] || `[${t[1]}]`}`;
          }).join(" ");
        },
        skewX: (v) => {
          var _a;
          const t = hasNegative(v);
          return `${t[0]}skew-x-${((_a = customTheme.skew) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && skewDefaultVs[t[1]] || `[${t[1]}]`}`;
        },
        skewY: (v) => {
          var _a;
          const t = hasNegative(v);
          return `${t[0]}skew-y-${((_a = customTheme.skew) == null ? void 0 : _a[t[1]]) || useAllDefaultValues && skewDefaultVs[t[1]] || `[${t[1]}]`}`;
        }
      };
      const vals = getCustomVal(val).replace(/\(.+?\)/g, (v) => v.replace(/_/g, "")).split(")_").map((v) => `${v})`);
      vals[vals.length - 1] = vals[vals.length - 1].slice(0, -1);
      ...
      const res = vals.map((v) => {
        let canUsePipeV = false;
        const pipeV = v.replace(/^([a-zA-Z0-9_-]+)\((.+?)\)$/, (_r, k, v2) => {
          var _a, _b;
          canUsePipeV = true;
          const tmpRes = (_b = (_a = transformValConfig[k]) == null ? void 0 : _a.call(transformValConfig, v2)) != null ? _b : canUse = false;
  ...
  [
    ...
    (val) => {
      ...
      }[getCustomVal(val)]) != null ? _a : `origin-[${getCustomVal(val)}]`;
    }
  ],
  [
    "transform-style",
  ...
  [
    ...
    (val) => {
      var _a;
      val = val.replace(/^([.\d]+)s$/, (_v, $1) => `${($1 * 1e3).toFixed(6).replace(/\.?0+$/, "")}ms`);
      return (_a = {
        "75ms": "delay-75",
        "100ms": "delay-100",
        "150ms": "delay-150",
        ...
        "700ms": "delay-700",
        "1000ms": "delay-1000"
      }[val]) != null ? _a : /^[.\d]+[ms]{1,2}$/.test(val) ? `delay-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "transition-duration",
    (val) => {
      ...
      }[val]) != null ? _a : /^[.\d]+[ms]{1,2}$/.test(val) ? `duration-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "transition-property",
  ...
  [
    ...
    (val) => {
      ...
      }[val]) != null ? _a : val.startsWith("cubic-bezier") ? `ease-[${getCustomVal(val)}]` : "";
    }
  ],
  [
    "unicode-bidi",
  ...
  [
    "width",
    (val) => isUnit(val) ? `w-${useAllDefaultValues && getRemDefaultVal(val) || getUnitMetacharactersVal(val, ["100vh" /* vh */]) || `[${val}]`}` : ""
  ],
  [
    "word-break",
    {
  ...
  [
    ...
    (val) => {
      ...
      return (_a = {
        ...
        "50": "z-50",
        "auto": "z-auto"
      }[val]) != null ? _a : typeof val === "number" ? `z-[${val}]` : "";
    }
  ]
]);
var parsingCode = (code) => {
  code = code.replace(/[\n\r]/g, "").trim();
  const tmpCodes = [];
  let index = 0;
...
var getResultCode = (it, prefix = "", config) => {
  ...
  const resultVals = cssCodeList.map((v) => {
    ...
    if (val === "initial" || val === "inherit") {
      ...
      config.customTheme = (_a = config.customTheme) != null ? _a : {};
      pipeVal = typeof pipe === "function" ? ((_b = config.customTheme[key.trim()]) == null ? void 0 : _b[val]) || config.useAllDefaultValues && ((_c = moreDefaultValuesMap[key.trim()]) == null ? void 0 : _c[val]) || pipe(val) : ((_d = config.customTheme[key.trim()]) == null ? void 0 : _d[val]) || config.useAllDefaultValues && ((_e = moreDefaultValuesMap[key.trim()]) == null ? void 0 : _e[val]) || ((_f = pipe == null ? void 0 : pipe[val]) != null ? _f : "");
    }
    if (((_h = (_g = config.prefix) == null ? void 0 : _g.length) != null ? _h : 0) > 0) {
      pipeVal = pipeVal.split(" ").map((v2) => `${v2[0] === "-" ? "-" : ""}${config.prefix}${v2.replace(/^-/, "")}`).join(" ");
    }
    if (hasImportant) {
      const getImportantVal = (v2) => {
        if (v2[0] === "[" && v2[v2.length - 1] === "]") {
          v2 = `${v2.slice(0, -1)}!important]`;
        } else {
          v2 = `!${v2}`;
        }
        return v2;
      };
      if (pipeVal.includes(" ") && ["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length === 0) {
        pipeVal = pipeVal.split(" ").map((v2) => getImportantVal(v2)).join(" ");
      } else if (pipeVal.length > 0) {
        pipeVal = getImportantVal(pipeVal);
      }
    }
    if (it.selectorName.endsWith(":hover") && pipeVal.length > 0) {
      if (["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length > 0) {
        pipeVal = `hover:${pipeVal}`;
      } else {
        pipeVal = pipeVal.split(" ").map((v2) => `hover:${v2}`).join(" ");
      }
    } else if (it.selectorName.endsWith(":focus") && pipeVal.length > 0) {
      if (["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length > 0) {
        pipeVal = `focus:${pipeVal}`;
      } else {
        pipeVal = pipeVal.split(" ").map((v2) => `focus:${v2}`).join(" ");
      }
    } else if (it.selectorName.endsWith(":active") && pipeVal.length > 0) {
      if (["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length > 0) {
        pipeVal = `active:${pipeVal}`;
      } else {
        pipeVal = pipeVal.split(" ").map((v2) => `active:${v2}`).join(" ");
      }
    } else if (it.selectorName.endsWith("::before") && pipeVal.length > 0) {
      if (["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length > 0) {
        pipeVal = `before:${pipeVal}`;
      } else {
        pipeVal = pipeVal.split(" ").map((v2) => `before:${v2}`).join(" ");
      }
    } else if (it.selectorName.endsWith("::after") && pipeVal.length > 0) {
      if (["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length > 0) {
        pipeVal = `after:${pipeVal}`;
      } else {
        pipeVal = pipeVal.split(" ").map((v2) => `after:${v2}`).join(" ");
      }
    }
    if (prefix.length > 0) {
      if (["backdrop-filter", "filter", "transform"].filter((v2) => pipeVal.startsWith(v2)).length > 0) {
        ...
        pipeVal = pipeVal.split(" ").map((v2) => `${prefix}:${v2}`).join(" ");
      }
    }
    return pipeVal;
  }).filter((v) => v !== "");
...
var defaultTranslatorConfig = {
  prefix: "",
  useAllDefaultValues: true,
  customTheme: {}
};
var CssToTailwind = (code, config = defaultTranslatorConfig) => {
  var _a, _b;
  ...
  useAllDefaultValues = (_a = config.useAllDefaultValues) != null ? _a : defaultTranslatorConfig.useAllDefaultValues;
  customTheme = (_b = config.customTheme) != null ? _b : defaultTranslatorConfig.customTheme;
  const dataArray = [];
  parsingCode(code).map((it) => {
    if (typeof it.cssCode === "string") {
      ...
      return it.cssCode.map((v) => {
        var _a2;
        const mediaName = getCustomVal(it.selectorName.replace(/\(.+\)/g, (v2) => v2.replace(/\s/g, "")).replace(/\s+\(/g, "("));
        const res = getResultCode(v, ((_a2 = customTheme.media) == null ? void 0 : _a2[it.selectorName]) || config.useAllDefaultValues && moreDefaultMediaVals[mediaName] || `[${mediaName}]`, config);
        return res ? {
